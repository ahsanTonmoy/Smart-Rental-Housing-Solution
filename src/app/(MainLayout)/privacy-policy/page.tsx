...
export const metadata: Metadata = {
  title: "Privacy Policy - BasaFinder | Smart Rental & Housing Solution ",
...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="mb-4">
        Welcome to BasaFinder. Your privacy is important to us. This Privacy
      ...
      <p className="mb-4">
        ...
        and phone number, as well as non-personal data related to website usage.
      </p>
      ...
      <p className="mb-4">
        Your information helps us provide and improve our services, personalize
        user experiences, and enhance security measures.
      </p>
      ...
      <p className="mb-4">
        ...
        data with trusted third-party service providers as necessary for
        business operations.
      </p>
      ...
      <p className="mb-4">
        We use cookies to improve user experience. You can choose to disable
      ...
      <h2 className="text-2xl font-semibold mt-6">7. Your Privacy Rights</h2>
      <p className="mb-4">
        You have the right to request access, correction, or deletion of your
        personal information stored with us.
      </p>
